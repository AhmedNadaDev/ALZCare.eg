...
const apiRequest = async (endpoint, options = {}) => {
  ...
  const token = localStorage.getItem(DOCTOR_TOKEN_KEY) || localStorage.getItem(FAMILY_TOKEN_KEY);
  if (token) {
...
export const tokenManager = {
  ...
  isAuthenticated: () => !!(localStorage.getItem(DOCTOR_TOKEN_KEY) || localStorage.getItem(FAMILY_TOKEN_KEY)),
  getUserType: () => {
